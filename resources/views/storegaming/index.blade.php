...
<div class="container">
    ...
    <div class="nk-image-slider" data-autoplay="8000">
        ...
        <div class="nk-image-slider-item">
            <img src="{{asset('assets/images/slide-1.jpg" alt="" class="nk-image-slider-img" data-thumb="assets/images/slide-1-thumb.jpg">
        ...
        <div class="nk-image-slider-item">
            <img src="{{asset('assets/images/slide-2.jpg" alt="" class="nk-image-slider-img" data-thumb="assets/images/slide-2-thumb.jpg">
        ...
        <div class="nk-image-slider-item">
            <img src="{{asset('assets/images/slide-3.jpg" alt="" class="nk-image-slider-img" data-thumb="assets/images/slide-3-thumb.jpg">
            
        </div>
        
        <div class="nk-image-slider-item">
            <img src="{{asset('assets/images/slide-4.jpg" alt="" class="nk-image-slider-img" data-thumb="assets/images/slide-4-thumb.jpg">
        ...
        <div class="nk-image-slider-item">
            <img src="{{asset('assets/images/slide-5.jpg" alt="" class="nk-image-slider-img" data-thumb="assets/images/slide-5-thumb.jpg">
    ...
    <div class="row vertical-gap">
        ...
        <div class="col-lg-4">
            <div class="nk-feature-1">
                <div class="nk-feature-icon">
                    <img src="{{asset('assets/images/icon-gamepad.png" alt="">
                </div>
                <div class="nk-feature-cont">
        ...
        <div class="col-lg-4">
            <div class="nk-feature-1">
                <div class="nk-feature-icon">
                    <img src="{{asset('assets/images/icon-gamepad-2.png" alt="">
                </div>
                <div class="nk-feature-cont">
                ...
                <div class="nano-content">
                    ...
                    <div class="nk-news-box-item nk-news-box-item-active">
                        <div class="nk-news-box-item-img">
                            <img src="{{asset('assets/images/post-1-sm.jpg" alt="Smell magic in the air. Or maybe barbecue">
                        </div>
                        <img src="{{asset('assets/images/post-1.jpg" alt="Smell magic in the air. Or maybe barbecue" class="nk-news-box-item-full-img">
                    ...
                    <div class="nk-news-box-item">
                        <div class="nk-news-box-item-img">
                            <img src="{{asset('assets/images/post-2-sm.jpg" alt="Grab your sword and fight the Horde">
                        </div>
    ...
    <div class="nk-blog-grid">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="nk-blog-post">
                    <a href="blog-article.html" class="nk-post-img">
                        <img src="{{asset('assets/images/post-5-mid.jpg" alt="He made his passenger captain of one">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="nk-blog-post">
                    <a href="blog-article.html" class="nk-post-img">
                        <img src="{{asset('assets/images/post-6-mid.jpg" alt="At first, for some time, I was not able to answer">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="nk-blog-post">
                    <a href="blog-article.html" class="nk-post-img">
                        <img src="{{asset('assets/images/post-7-mid.jpg" alt="At length one of them called out in a clear">
                        <span class="nk-post-comments-count">0</span>
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="nk-blog-post">
                    <a href="blog-article.html" class="nk-post-img">
                        <img src="{{asset('assets/images/post-8-mid.jpg" alt="For good, too though, in consequence">
                        <span class="nk-post-comments-count">0</span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <div class="nk-post-by">
                                <img src="{{asset('assets/images/avatar-3.jpg" alt="Wolfenstein" class="rounded-circle" width="35"> by <a href="#">Wolfenstein</a> in Jul 23, 2018
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                                <p>Just then her head struck against the roof of the hall: in fact she was now more than nine feet high, and she at once took up the little golden key and hurried off to the garden door...</p>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <h2 class="nk-post-title h4"><a href="blog-article.html">At first, for some time, I was not able to answer</a></h2>
                            <div class="nk-post-by">
                                <img src="{{asset('assets/images/avatar-3.jpg" alt="Wolfenstein" class="rounded-circle" width="35"> by <a href="#">Wolfenstein</a> in Jul 3, 2018
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                                <p>This little wandering journey, without settled place of abode, had been so unpleasant to me, that my own house, as I called it to myself, was a perfect settlement to me compared to that...</p>
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        <div class="col-lg-3 col-md-5">
            <a href="blog-article.html" class="nk-post-img">
                <img src="{{asset('assets/images/post-7-mid-square.jpg" alt="At length one of them called out in a clear">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        <div class="col-lg-3 col-md-5">
            <a href="blog-article.html" class="nk-post-img">
                <img src="{{asset('assets/images/post-9-mid-square.jpg" alt="He made his passenger captain of one">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <a href="blog-article.html" class="nk-post-img">
        <img src="{{asset('assets/images/post-1-fw.jpg" alt="Smell magic in the air. Or maybe barbecue">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        <div class="col-lg-3 col-md-5">
            <a href="blog-article.html" class="nk-post-img">
                <img src="{{asset('assets/images/post-5-mid-square.jpg" alt="He made his passenger captain of one">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        <div class="col-lg-3 col-md-5">
            <a href="blog-article.html" class="nk-post-img">
                <img src="{{asset('assets/images/post-4-mid-square.jpg" alt="For good, too though, in consequence">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <a href="blog-article.html" class="nk-post-img">
        <img src="{{asset('assets/images/post-6-fw.jpg" alt="At first, for some time, I was not able to answer">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <a href="blog-article.html" class="nk-post-img">
        <img src="{{asset('assets/images/post-7-fw.jpg" alt="At length one of them called out in a clear">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        <div class="col-lg-3 col-md-5">
            <a href="blog-article.html" class="nk-post-img">
                <img src="{{asset('assets/images/post-3-mid-square.jpg" alt="We found a witch! May we burn her?">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="nk-gallery-item-box">
                            <a href="assets/images/gallery-1.jpg" class="nk-gallery-item" data-size="1016x572">
                                ...
                                <img src="{{asset('assets/images/gallery-1-thumb.jpg" alt="">
                            </a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="nk-gallery-item-box">
                            <a href="assets/images/gallery-3.jpg" class="nk-gallery-item" data-size="625x350">
                                <div class="nk-gallery-item-overlay"><span class="ion-eye"></span></div>
                                <img src="{{asset('assets/images/gallery-3-thumb.jpg" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="nk-gallery-item-box">
                            <a href="assets/images/gallery-4.jpg" class="nk-gallery-item" data-size="873x567">
                                <div class="nk-gallery-item-overlay"><span class="ion-eye"></span></div>
                                <img src="{{asset('assets/images/gallery-4-thumb.jpg" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="nk-gallery-item-box">
                            <a href="assets/images/gallery-5.jpg" class="nk-gallery-item" data-size="471x269">
                                <div class="nk-gallery-item-overlay"><span class="ion-eye"></span></div>
                                <img src="{{asset('assets/images/gallery-5-thumb.jpg" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="nk-gallery-item-box">
                            <a href="assets/images/gallery-6.jpg" class="nk-gallery-item" data-size="472x438">
                                <div class="nk-gallery-item-overlay"><span class="ion-eye"></span></div>
                                <img src="{{asset('assets/images/gallery-6-thumb.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
